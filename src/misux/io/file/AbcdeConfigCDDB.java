 ...
 * 
 */
public class AbcdeConfigCDDB extends File
{
   ...
   * @throws Exception
   */
  public AbcdeConfigCDDB() throws Exception
  {
    super();
    setOverwrite(true);
  }
  ...
  public String createContent () throws Exception
  {
    ...
    final String configDir = Preferences.get().getOption("io.config.dir")
        .getStringValue();
  ...
  {
    final String tmp = Preferences.get()
        .getOption("io.music.rip.abcde.config.cddb").getStringValue();
